          ...
          describe('#requestRandomWords', async function () {
              describe('success', async function () {
                  ...
                  it('Should successfully request a random number and get a result', async function () {
                      ...
                      assert(firstRandomNumber.gt(ethers.constants.Zero), 'First random number is greather than zero')

                      assert(secondRandomNumber.gt(ethers.constants.Zero), 'Second random number is greather than zero')
                  })
