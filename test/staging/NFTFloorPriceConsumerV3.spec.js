...
developmentChains.includes(network.name)
    ...
    : describe('NFT Floor Price Consumer V3 Staging Tests', async function () {
          ...
          before(async function () {
              ...
              const nftFloorPriceConsumerV3Factory = await ethers.getContractFactory('NFTFloorPriceConsumerV3')
              nftFloorPriceConsumerV3 = await nftFloorPriceConsumerV3Factory.connect(deployer).deploy()
          })
