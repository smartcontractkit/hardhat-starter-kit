...
library OCR2DR {
        ...
        if (self.queries.length > 0) {
            ...
            for (uint256 i = 0; i < self.queries.length; i++) {
                ...
                if (self.queries[i].headers.length > 0) {
                    ...
                    for (
                        uint256 j = 0;
                        j < self.queries[i].headers.length;
                        j++
                    ) {
     ...
     */
    function setHttpHeaders(HttpQuery memory self, HttpHeader[] memory headers)
        internal
        pure
    {
     ...
     */
    function addHttpQuery(Request memory self, HttpQuery memory query)
        internal
        pure
    {
     ...
     */
    function setHttpQueries(Request memory self, HttpQuery[] memory queries)
        internal
        pure
    {
