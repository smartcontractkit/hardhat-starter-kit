...
export interface AutomationCounterInterface extends utils.Interface {
  functions: {
...
export interface AutomationCounter extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AutomationCounterInterface;
