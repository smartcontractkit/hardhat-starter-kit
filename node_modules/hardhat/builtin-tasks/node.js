...
config_env_1.subtask(task_names_1.TASK_NODE_GET_PROVIDER)
    ...
    const forkUrl = forkUrlParam !== null && forkUrlParam !== void 0 ? forkUrlParam : (_a = hardhatNetworkConfig.forking) === null || _a === void 0 ? void 0 : _a.url;
    const forkBlockNumber = forkBlockNumberParam !== null && forkBlockNumberParam !== void 0 ? forkBlockNumberParam : (_b = hardhatNetworkConfig.forking) === null || _b === void 0 ? void 0 : _b.blockNumber;
