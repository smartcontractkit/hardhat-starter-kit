...
export declare function loadConfigAndTasks(hardhatArguments?: Partial<HardhatArguments>, { showWarningIfNoSolidityConfig }?: {
    showWarningIfNoSolidityConfig: boolean;
}): HardhatConfig;
/**
