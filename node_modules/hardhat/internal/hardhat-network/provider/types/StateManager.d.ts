...
export interface StateManager {
     ...
     * @param cb - Callback function
     */
    getOriginalContractStorage(address: Buffer, key: Buffer, cb: Callback<Buffer>): void;
    /**
     ...
     * @param cb - Callback function
     */
    putContractStorage(address: Buffer, key: Buffer, value: Buffer, cb: Callback): void;
    /**
