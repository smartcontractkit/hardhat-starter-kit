...
export interface PStateManager {
    ...
    readonly getOriginalContractStorage: (address: Buffer, key: Buffer) => Promise<any>;
    readonly putContractStorage: (address: Buffer, key: Buffer, value: Buffer) => Promise<void>;
...
//# sourceMappingURL=PStateManager.d.ts.map