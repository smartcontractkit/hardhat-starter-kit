...
export class GasGuzzlingConsumer extends Contract {
  ...
  estimate: {
    ...
    gassyFulfill(_requestId: Arrayish, _price: Arrayish): Promise<BigNumber>;
    ...
    gassyMultiWordRequest(_payment: BigNumberish): Promise<BigNumber>;

    gassyRequestEthereumPrice(_payment: BigNumberish): Promise<BigNumber>;
