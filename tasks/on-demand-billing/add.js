...
task(
    'add-on-demand-consumer',
    'Adds a client contract to the On-Demand billing subscription'
).addParam(
    "subid",
    "Subscripton ID"
).addParam(
    "consumer",
    "Address of the On-Demand client contract to authorize for billing"
    ...
    console.log(`${postSubInfo[2].length} authorized consumer contract${postSubInfo[2].length === 1 ? '' : 's'} for subscription ${subscriptionId}:`)
